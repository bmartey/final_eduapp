    ...
    return {
        ...
        addLocalFolder : function(/*String*/localPath, /*String*/zipPath, /*RegExp|Function*/filter) {
            if (filter === undefined) {
              ...
              }(filtes and directories to the archive
         *
         * @param localPath
         * @param zipPath optional path inside zip
         * @param filter optional RegExp or Function if files match will
         *               be included.
         */
        addLocalFolder : function(/*String*/localPath, /*String*/zipPath, /*RegExp|Functi-Path.length - 1) != "/"){
                        zipPath += "/";
                    }
                }else{
                    zipPath="";
                 ...
                 if(zipName){
                    this.addFile(zipPath+zipName, fs.readFileSyn.forEach(function(path) {
